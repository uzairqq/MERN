...
exports.is = curry_1.curry(function (expected, actual) { return new Is(expected, actual); });
var Is = (function () {
    ...
    Is.prototype.verify = function (verification) {
        ...
        if (expected === actual)
            ...
            verification.failure(helpers_1.formatError("Not Same Reference", expected, actual));
    };
    return Is;
}());
exports.Is = Is;
